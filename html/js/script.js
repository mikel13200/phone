        ...
        if (action !== undefined) {
            switch (action) {
                ...
                case "dabcoin":
                    ...
                    break;
				case "911-distress":
                    $.post('https://phone/911distress', JSON.stringify({ job: $(this).data('action-data') }));
                    break;
				case "boss-manage-emp":
                    $.post('https://phone/bossMngEmployee', JSON.stringify({ society: $(this).data('job-society') }));
                    break; 
				case "gang-info":
                    $.post('https://phone/gangInfo', JSON.stringify({ 
                        gang: $(this).data('gang-name'),
                        position: $(this).data('gang-position')
                    }));
                    break;     
                case "gang-manage-mem":
                    $.post('https://phone/gangMngMembers', JSON.stringify({ gang: $(this).data('gang-name') }));
                    break;  
                case "gang-restock":
                    $.post('https://phone/gangRestock', JSON.stringify({ 
                        restocktype: $(this).data('gang-restock-type'), 
                        gang: $(this).data('gang-name') 
                    }));
                    break;  
                case "gang-task-list":
                    $.post('https://phone/businessTasks', JSON.stringify({ 
...
$("#business-task-assign-modal-form").submit(function (e) {
    ...
    $.post('https://phone/AssignBusinessTask', JSON.stringify({
...
$("#boombox-bluetooth-modal-form").submit(function (e) {
    ...
    $.post('https://phone/PairDevice', JSON.stringify({
...
$("#boss-recruit-emp-form").submit(function (e) {
    ...
    $.post('https://phone/recruitEmployee', JSON.stringify({
...
$('.messages-ping-contact').click(function () {
    $.post('https://phone/pingContact', JSON.stringify({ name: $('.message-entries').data('displayName'), number: $('.message-entries').data('sender') }));    
});

$('.ping-entries').on('click', '.ping-accept', function (e) {
    $.post('https://phone/acceptPing', JSON.stringify({ pingId: $(this).data('ping-id') }));
});
...
$('.bmarket-pages-entries').on('click', '.bmarket-accept-offer', function () {
    $.post('https://phone/bmAcceptOffer', JSON.stringify({
...
$('.delivery-job-entries').on('click', '.delivery-job-accept', function (e) {
    $.post('https://phone/selectedJob', JSON.stringify({ jobId: $(this).data('job-id') }));
});
...
$('.contacts-entries, .call-history-entries').on('click', '.btn-contacts-ping', function (event) {
    $.post('https://phone/pingContact', JSON.stringify({ name: $(this).data('name'), number: $(this).data('number') }));
});
...
$('.invoice-entries').on('click', '.pay-invoice', function (e) {
     $.post('https://phone/payInvoice', JSON.stringify({ billID: $(this).data('invoice-id') }));
});

$('.business-entries').on('click', '.business-tasks', function (e) {
     $.post('https://phone/businessTasks', JSON.stringify({ name: $(this).data('business-name') }));
});
...
$('.business-tasks-entries').on('click', '.business-cancel-task', function (e) {
     $.post('https://phone/CancelBusinessTask', JSON.stringify({ 
...
$('.tasks-entries').on('click', '.task-accept', function (e) {
    $.post('https://phone/acceptTask', JSON.stringify({ 
        taskid: $(this).data('task-id'),
        businessname: $(this).data('business-name')
    }));
});
...
$('#confirm-promote-modal-accept').click(function (event) {
    $.post('https://phone/promoteEmploee', JSON.stringify({ 
...
$('#confirm-fire-modal-accept').click(function (event) {
    $.post('https://phone/fireEmployee', JSON.stringify({ 
        identifier: $(this).data('emp-identifier'), 
        name: $(this).data('emp-name'),
        grade: $(this).data('emp-grade'),
        job: $(this).data('emp-job'),
...
$('#confirm-promote-mem-modal-accept').click(function (event) {
    $.post('https://phone/promoteGangMember', JSON.stringify({ 
...
$('#confirm-kick-mem-modal-accept').click(function (event) {
    $.post('https://phone/kickGangMember', JSON.stringify({ 
        identifier: $(this).data('gang-mem-identifier'), 
        name: $(this).data('gang-mem-name')
    }));
...
$('#confirm-gang-leave-modal-accept').click(function (event) {
    $.post('https://phone/btnGangLeave', JSON.stringify());
...
$("#gang-hire-form").submit(function (e) {
    ...
    $.post('https://phone/recruitGangMember', JSON.stringify({
